...
export const DialogueDcaFailedDetails: React.FC<DCADetailsDialogProps> = ({
  dca,
  children,
}) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        className={cn(failedAfterLastRun ? "min-w-2/3" : "", "overflow-hidden")}
      >
        <DialogHeader>
          <DialogTitle>DCA Schedule Details</DialogTitle>
          <DialogDescription>
            Detailed information about your DCA schedule.
          </DialogDescription>
        </DialogHeader>
