...
import { InputAmount } from "@/components/co-pilot/input-amount";
import { SelectFrequency } from "@/components/co-pilot/select-frequency";
...
export const DialogueEditDCA: React.FC<EditDialogProps> = ({
  dca,
  onUpdate,
}) => {
  const { data } = dca;
